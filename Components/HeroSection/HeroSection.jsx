...
const HeroSection = ({}) => {
  ...
  const {singleSwapToken, connectWallet, account, ether, dai, tokenData, getPrice, swapUpdatePrice} = useContext(SwapTokenContext);
 //TOKEN 1
      ...
      <div className={Style.HeroSection_box}>
          ...
          {/*<input
            type="text"
             ...
             <p>
              {search ? (
                  <Image
              src={images.image || images.loading}
              width={50}
              height={30}
              alt="loading"
            />
        ...
        {account ? (
          <button
            ...
            onClick={() => singleSwapToken({token1: tokenOne,
              token2: tokenTwo,
              swapAmount,})}>
              Swap
          </button>
