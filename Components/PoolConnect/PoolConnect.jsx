      ...
      <div className={Style.PoolConnect_box}>
        ...
        <div className={Style.PoolConnect_box_info}>
          <div className={Style.PoolConnect_box_info_left}>
            ...
            <a href="https://support.uniswap.org/hc/en-us/categories/8122334631437-Providing-Liquidity-">LP walkthrough and migration guides.</a>
          </div>
          <div className={Style.PoolConnect_box_info_right}> 
            <h5>Top pools</h5>
            <a href="https://info.uniswap.org/#/pools">Explore analytics</a>
          </div>
        </div>
      </div>
    </div>
